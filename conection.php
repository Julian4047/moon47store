...
function insertar($conexion) {
    ...
    $consulta = "INSERT INTO orders(Nombre,Apellido,CorreoElectronico,NumeroDeMovil,NDeDocumento,Calle,Altura,Localidad,DateS,MontoAbonado,CantidadDePrendas,NombreDePrendas,AbonoEnvio) 
